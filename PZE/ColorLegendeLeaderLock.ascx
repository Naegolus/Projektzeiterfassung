...
<%@ Control Language="C#" AutoEventWireup="True" Inherits="ColorLegendeLeaderLock" Codebehind="ColorLegendeLeaderLock.ascx.cs" %>
...
<asp:Table ID="Legend" runat="server">
    ...
    <asp:TableRow>
        ...
        <asp:TableCell ColumnSpan="2">
            <dx:ASPxLabel runat="server" Text="Vorgesetzter freigegeben" />
        </asp:TableCell>
    </asp:TableRow>
</asp:Table>