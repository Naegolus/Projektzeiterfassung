...
<%@ Page  Title="Mitarbeiter Freigabe" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" Inherits="com.commend.tools.PZE.LockRecordEmployee" Codebehind="LockRecordEmployee.aspx.cs" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    ...
    <fieldset runat="server">
        <legend>Mitarbeiterfreigabe</legend>
        <table>
            <tr align="center">
                <td align="center">
                                        ...
                                        <tr>
                                            ...
                                            <td style="white-space: nowrap; padding-left: 3px" colspan="3">
                                               <dx:ASPxLabel runat="server" Width="300px" Height="75px" Wrap="True" ID="LblSelComments"/>
                                                <%--<dx:ASPxMemo runat="server" Width="170px" Height="75px" Wrap="True" ID="LblSelComments"/>--%>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                ...
                <dx:ASPxCallbackPanel runat="server" ClientInstanceName="notifyCalendarSelChangedGrid"
                    ...
                    <PanelCollection>
                        <dx:PanelContent runat="server">
                            <my:HistoryGrid ID="InternalHistoryGrid" runat="server" Visible="true" EmployeeLockView="true" LeaderLockView="false"/>
                        </dx:PanelContent>
                    </PanelCollection>
                </dx:ASPxCallbackPanel>
            </tr>
